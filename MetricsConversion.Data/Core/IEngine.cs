...
namespace MetricsConversion.Data.Core
{
    ...
    public interface IEngine
    {
        ...
        /// <param name="simpleMktConfig">Nop configuration parameters</param>
        void ConfigureServices(IServiceCollection services, IConfiguration configuration, Config simpleMktConfig);
        ...
        /// <param name="simpleMktConfig">Nop configuration parameters</param>
        void RegisterDependencies(ContainerBuilder containerBuilder, Config simpleMktConfig);
    }
}
