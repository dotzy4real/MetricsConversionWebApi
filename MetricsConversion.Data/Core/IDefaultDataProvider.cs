...
namespace MetricsConversion.Data.Core
{
    ...
    /// </summary>
    public partial interface IDefaultDataProvider
    {
        #region Methods
        ...
        TEntity InsertEntityWithAudit<TEntity>(TEntity entity) where TEntity : BaseEntityWithAudit;
        ...
        /// <typeparam name="TEntity">Entity type</typeparam>
        void UpdateEntityWithAudit<TEntity>(TEntity entity) where TEntity : BaseEntityWithAudit;
        ...
        /// </summary>
        /// <param name="simpleMktConnectionString">Connection string info</param>
        /// <returns>Connection string</returns>
        /// 

        //string BuildConnectionString(ISimpleMarketConnectionStringInfo simpleMktConnectionString);
