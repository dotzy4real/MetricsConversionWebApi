...
namespace MetricsConversion.Data.Core
{
    ...
    public class DefaultEngine : IEngine
    {
        ...
        /// <param name="defaultConfig">Nop configuration parameters</param>
        public virtual void RegisterDependencies(ContainerBuilder containerBuilder, Config defaultConfig)
        {
            //register engine
            ...
            foreach (var dependencyRegistrar in instances)
                dependencyRegistrar.Register(containerBuilder, _typeFinder, defaultConfig);
        }
        ...
        /// <param name="defaultConfig">Nop configuration parameters</param>
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration, Config defaultConfig)
        {
            //find startup configurations provided by other assemblies
            _typeFinder = new WebAppTypeFinder();
            var startupConfigurations = _typeFinder.FindClassesOfType<IDefaultStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations
                .Select(startup => (IDefaultStartup)Activator.CreateInstance(startup))
        ...
        public void ConfigureRequestPipeline(IApplicationBuilder application)
        {
            ...
            var startupConfigurations = typeFinder.FindClassesOfType<IDefaultStartup>();
